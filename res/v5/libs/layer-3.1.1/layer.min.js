...
! function(e, t) {
	...
	r.prompt = function(e, t) {
		...
		return delete e.success, r.open(i.extend({
			...
			yes: function(i) {
				var n = s.val();
				"" === n ? s.focus() : n.length > (e.maxlength || 500) ? r.tips("Đầu vào tối đa" + (e.maxlength || 500) + "số từ", s, {
					tips: 1
				}) : t && t(n, i, s)
			}
		}, e))
		...
		if (t = t || {}, t.photos) {
			...
			if (delete t.success, l) {
				if (0 === u.length) return r.msg("Không có hình ảnh")
			} else {
				var p = i(t.photos),
					h = function() {
			...
			s.imgprev = function(e) {
				...
				r.close(s.loadi), r.msg("Địa chỉ hình ảnh hiện tại không bình thường<br>Tiếp tục xem hình ảnh tiếp theo?", {
					time: 3e4,
					btn: ["Kế tiếp", "Dừng xem"],
					yes: function() {
