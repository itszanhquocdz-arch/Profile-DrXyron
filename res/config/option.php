...
class ThanhDieuHeader implements ThanhDieuConfigInterface {
    public $title = "Hoàng Anh Quốc | Resources V5";
    public $description = "Hi my name is AnhQuoc / A freelance / web developer / vexer";
    public $keywords = "anhquoc,webanhquoc,hoanganhquoc,anhquoctv,drxyron,itszanhquocdz,hanhquoc,profile anhquoc";
    public $favicon = "./res/v5/img/logo.jpg";
    public $namesite = "ANHQUOC | HOME";
    public $avatar = "./res/v5/img/avatar.gif";
    public $userName = ["Hello Everybody", "My name is AnhQuoc.", "I really like website design 🌭"];
    ...
    public $SocialNetworks = [
        "facebook" => "https://www.facebook.com/share/17v9QXheMM/?mibextid=wwXIfr", // Thay link facebook
        "instagram" => "https://www.instagram.com", // Thay link instagram
        "tiktok" => "https://www.tiktok.com/", // Thay link tiktok
        "discord" => "https://www.discord.con" // Thay link discord
    ];
...
class ThanhDieuLoveDays implements ThanhDieuConfigInterface {
    public $ConfigLove = [
        ...
        "name_male" => "Anh Quoc", // Thay tên của bạn
        //========================================================//
        ...
        "name_female" => "Thanh Thuy", // Thay tên đối phương
        //========================================================//
        "time_relashiption" => "10/09/2025" // Định dạng ngày tháng năm: DD-MM-YYYY or / or :
        //========================================================//
    ];
    public function CommonMethod() {}
}
